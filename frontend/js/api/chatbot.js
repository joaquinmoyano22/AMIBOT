    ...
    async function consultarGeminis(pregunta) {
        ...
        try {
            ...
            if (!resp.ok) {
                ...
                agregarMensajeBot("❌ Error al comunicar con el servicio (HTTP " + resp.status + ").");
                return;
            }
            ...
            if (!parts || !parts.length) {
                removeTypingIndicator(typing);
                agregarMensajeBot("❌ No pude obtener una respuesta, intentá de nuevo.");
                return;
            }
